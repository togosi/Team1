...
def und(life,maxhp,enemylife,pwr,spd,Lock_on,a1,a2,a2_rev,a3,a5):
    ...
    def atk3(dmg,spd):
        ...
        if size >= 150:
            ...
            while True:
                ...
                if px-90 < rx < px-60 or px+60 < rx < px+90:
                    break
            while True:
                ry = random.randint(260,560)
                if py-90 < ry < py-60 or py+60 < ry < py+90:
                    break            
    ...
    def atk5(dmg,spd,Lock_on):
        ...
        if y1 >= 540-spd:
            ...
            y1 = 50
            pygame.mixer.music.load("風切り音（軽）.mp3")
...
if __name__ == "__main__":
    print(und(100,100,20,10,5,"T","F","F","F","F","T"))