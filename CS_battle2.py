...
def und(life,maxhp,enemylife,pwr,spd,Lock_on,a1,a2,a2_rev,a3,a5):
    global px,py,white,black,red,cnt_atk1,cnt_atk3,inv,myhp,e_maxhp,enemyhp,ecnt,mysize,y1,y2,rx,ry,clock,key,defeated
    import pygame
    import sys
    import random
    #import CS_maze
    ...
    def atk5(dmg,spd,Lock_on):
        ...
        if y1 < 540-spd*2:
            pygame.draw.rect(screen,white,[x1,y1,20,100])
            #pygame.draw.rect(screen,white,[y1-80,x2,100,20])
            pygame.draw.rect(screen,black,[x1,y1-spd*2,20,spd*2])
            #pygame.draw.rect(screen,black,[y1-80-spd,x2,spd,20])
            pygame.draw.rect(screen,white,[160,250,320,10])
            #pygame.draw.rect(screen,white,[160,250,10,320])
            #pygame.draw.rect(screen,white,[470,250,10,320])
            ...
            pcl()
        if y1 >= 540-spd*2:
            pygame.draw.rect(screen,black,[x1,y1-spd*2,20,100])
            #pygame.draw.rect(screen,black,[y1-80-spd,x2,100,20])
    ...
    def __init__(): 
        ...
        screen.blit(font.render(txt,True,white),[50,300])
    ...
    def main(Lock_on,a1,a2,a2_rev,a3,a5):
        ...
        while True:
            ...
            if myhp <= 0:
                ...
                pygame.display.update()
                se = pygame.mixer.Sound("Onoma-Ding03-4(High-Long).mp3")
                se.play()
                #defeated = 1
                while True:
                    endcnt += 1
    ...
    #     txt = "Press E to end the game"
    #     screen.blit(font.render(txt,True,white),[175,370])
    #     txt = "Press R to restart the game"
    #     screen.blit(font.render(txt,True,white),[175,420])
    #     pygame.display.update()
...
if __name__ == "__main__":
    print(und(1,100,2,10,5,"T","F","F","F","F","T"))